"""
Unit tests for AuthService - TDD Implementation (Complete Fixed Version)
...
class TestAuthService:
    ...
    async def test_register_user_success(self, auth_service, sample_user_data):
        ...
        # Arrange
        with patch.object(auth_service, '_get_user_by_email', return_value=None):
            with patch.object(auth_service, '_validate_password_strength', return_value=True):
    ...
    @pytest.mark.asyncio
    async def test_register_user_email_already_exists(self, auth_service, sample_user_data, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_verify_email_already_verified(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_change_password_invalid_old_password(self, auth_service, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_request_success(self, auth_service, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_request_user_not_found(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_weak_password(self, auth_service, sample_user):
