...
class TestAuthService:
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_unverified_account(self, def test_authenticate_user_unverified_account(self, auth_service, sample_user_data):
    ...
    @pytest.mark.asyncio
    async def test_register_user_success(self, def test_register_user_success(self, auth_service, sample_user_data):
    ...
    @pytest.mark.asyncio
    async def test_register_user_email_already_exists(self, def test_register_user_email_already_exists(self, auth_service, sample_user_data, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_register_user_weak_password(self, def test_register_user_weak_password(self, auth_service, sample_user_data):
        """Test registration with weak password"""
        # Arrange
        weak_password_data = {**sample_user_data, "password": "123"}
        
        # Act
        result = await auth_service.register_user(weak_password_data)
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_success(self, def test_refresh_token_success(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_invalid_token(self, def test_refresh_token_invalid_token(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_logout_user_success(self, def test_logout_user_success(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_verify_email_success(self, def test_verify_email_success(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_verify_email_invalid_token(self, def test_verify_email_invalid_token(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_verify_email_already_verified(self, def test_verify_email_already_verified(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_change_password_success(self, def test_change_password_success(self, auth_service, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_change_password_invalid_old_password(self, def test_change_password_invalid_old_password(self, auth_service, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_change_password_weak_new_password(self, def test_change_password_weak_new_password(self, auth_service, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_request_success(self, def test_reset_password_request_success(self, auth_service, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_request_user_not_found(self, def test_reset_password_request_user_not_found(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_success(self, def test_reset_password_success(self, auth_service, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_invalid_token(self, def test_reset_password_invalid_token(self, auth_service):
    ...
    @pytest.mark.asyncio
    async def test_reset_password_weak_password(self, def test_reset_password_weak_password(self, auth_service, sample_user):
        ...
        with patch.object(auth_service, '_decode_token', return_value={"user_id": user_id}):
            with patch.object(auth_service, '_get_user_by_id', return_value=sample_user):
                # Act
                result = await auth_service.reset_password(reset_token, weak_password)
